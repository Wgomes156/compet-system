...
export const api = {
    ...
    deleteAtleta: (id) => fetch(`${API_BASE_URL}/atletas/${id}`, { method: 'DELETE' }).then(res => res.json()),
    ...
    deleteEquipe: (id) => fetch(`${API_BASE_URL}/equipes/${id}`, { method: 'DELETE' }).then(res => res.json()),
    ...
    // Chaveamento
    getChaveamento: (categoriaId) => fetch(`${API_BASE_URL}/chaveamento/categoria/${categoriaId}`).then(res => res.json()),
